...
echo     $cur = 0 >> "%PS%"
echo     $items = @('Yes - Send my basic system info','No  - Skip and continue to TheKaverian's CMDTools') >> "%PS%"
echo     while ($true) { >> "%PS%"
echo         Clear-Host >> "%PS%"
echo         Write-Host "" >> "%PS%"
...
echo     Set-Content -Path $flagFile -Value "!! DO NOT DELETE THIS FILE - it is used by CMDTools to track diagnostics !!" >> "%PS%"
